                    ...
                    items: Array.from({ length: 4 }, (_, j) => {
                        return {
                            time_start:
                                String(
                                    new Date(
                                        this.calculateDayDate(new Date(), j)
                                    )
                                        .toISOString()
                                        .slice(0, 10)
                                ) +
                ...
                row.items.forEach(async cell => {
                    if (cell.availability !== '') {
                        ...
                        const end_time = new Date(
                            new Date(cell.time_start + 'Z').getTime() +
                                30 * 60000
                        )
                            .toISOString()
                            .slice(0, 16)
