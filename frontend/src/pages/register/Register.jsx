                ...
                <div className='register-form'>
                    <form onSubmit={e => e.preventDefault()}>
                        <div>
                            ...
                            />
                            {usernameError
                                ? FormFieldErrorMessage(usernameError)
                                : null}
                        </div>
                        ...
                        <div>
                            ...
                            />
                            {firstNameError
                                ? FormFieldErrorMessage(firstNameError)
                                : null}
                        </div>
                        ...
                        <div>
                            ...
                            />
                            {lastNameError
                                ? FormFieldErrorMessage(lastNameError)
                                : null}
                        </div>

                        <div>
                            <label className='register-field-label' for='email'>
                                Email *
                            </label>
                            <input
                                className='register-field-input'
                            ...
                            />
                            {emailError
                                ? FormFieldErrorMessage(emailError)
                                : null}
                        </div>
                        ...
                        <div>
                            ...
                            />
                            {password1Error
                                ? FormFieldErrorMessage(password1Error)
                                : null}
                        </div>
                        ...
                        <div>
                            ...
                            />
                            {password2Error
                                ? FormFieldErrorMessage(password2Error)
                                : null}
                        </div>
...
function FormFieldErrorMessage(message) {
    return <p className='register-form-error'>{message}</p>
}
